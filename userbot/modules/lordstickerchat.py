...
if 1 == 1:
    strings = {
        "name": "Quotes",
        "api_token_cfg_doc": "API Key/Token Untuk Quotes.",
        "api_url_cfg_doc": "API URL Untuk Quotes.",
        "colors_cfg_doc": "Warna Username",
        "default_username_color_cfg_doc": "Default Warna Untuk Username.",
        "no_reply": "<b>Lord, Anda Harus Membalas Ke Pesan</b>",
        "no_template": "<b>Lord, Anda Harus Menentukan Template</b>",
        "delimiter": "</code>, <code>",
        "server_error": "<b>Terjadi Kesalahan Server. Harap Melapor Ke Developer.</b>",
        "invalid_token": "<b>Anda Belum Menyetel Token, Dapatkan Token Dari `http://antiddos.systems`.</b>",
        "unauthorized": "<b>Anda Tidak Memiliki Izin Untuk Melakukan Ini.</b>",
        "not_enough_permissions": "<b>Template Salah, Anda Hanya Bisa Menggunakan Default Satu.</b>",
        "templates": "<b>Template Yang Tersedia:</b> <code>{}</code>",
        "cannot_send_stickers": "<b>Anda Tidak Bisa Mengirim Sticker Dalam Grup Ini</b>",
        "admin": "admin",
        "creator": "creator",
        "hidden": "hidden",
        "channel": "Channel",
        ...
        if resp["status"] == 500:
            ...
            if resp["message"] == "ERROR_TEMPLATE_NOT_FOUND":
                ...
                if newreq["status"] == "NOT_ENOUGH_PERMISSIONS":
                    ...
                    raise ValueError("Terjadi Kesalahan Server Tidak Merespon", newreq)
            else:
                raise ValueError("Terjadi Kesalahan Server Tidak Merespon", resp)
...
CMD_HELP.update(
    {
        "stickerchat": "`.pch` \
          \nUsage: Sama kaya quotly, mengubah pesanmu ke sticker."
    }
)
